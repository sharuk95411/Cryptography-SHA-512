...
public class PasswordTakerForEncryption extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        getContentPane().add(passwordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 56, 803, -1));
        ...
        getContentPane().add(passwordField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 107, 803, -1));

        proceedButton.setBackground(new java.awt.Color(255, 255, 51));
        ...
        getContentPane().add(proceedButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 140, 130, 28));
        ...
        getContentPane().add(suggestionLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 803, 19));

        eightCharInstructionLabel.setForeground(new java.awt.Color(255, 0, 0));
        eightCharInstructionLabel.setText("For security reasons you must enter password of atleast 8 characters");
        eightCharInstructionLabel.setFocusable(false);
        getContentPane().add(eightCharInstructionLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 133, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/bg.jpg"))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 820, 180));
